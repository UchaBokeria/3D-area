...
export class room extends simulate {
    ...
    init() {
        ...
        ;(this.ax = new THREE.Vector3(0, 0, 0)), new THREE.Vector3(0, 0, 0), 5.35
        this.playerCollider = new Capsule(this.ax)
    ...
    teleportPlayerIfOob() {
        ...
        this.playerCollider.start.set(0, 0, 5)
        this.playerCollider.end.set(0, 100, 0)
